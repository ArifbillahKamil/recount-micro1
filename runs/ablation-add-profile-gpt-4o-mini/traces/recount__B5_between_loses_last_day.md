...
`2` model calls (`1` replayed from cassette) · `3` tool calls · `1498` tokens · `$0.00034`
...
`gpt-4o-mini` · live call · 354 in / 88 out · 2.07s
...
`gpt-4o-mini` · replayed · 879 in / 177 out · 0.00s
