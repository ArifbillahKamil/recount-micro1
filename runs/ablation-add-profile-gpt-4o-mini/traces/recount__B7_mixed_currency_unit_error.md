...
`2` model calls (`0` replayed from cassette) · `4` tool calls · `1799` tokens · `$0.00037`
...
`gpt-4o-mini` · live call · 580 in / 85 out · 1.29s
...
`gpt-4o-mini` · live call · 1001 in / 133 out · 1.51s
