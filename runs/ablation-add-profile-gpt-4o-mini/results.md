...
Model `gpt-4o-mini` · mode `auto` · profile on · formats on · probes OFF · gate on
...
| `B4_left_join_degraded_to_inner` | BUG | BUG | TP | wrong_aggregation_grain | correct | The query under review counts the number of refunds (103) instead of t... |
...
```json
{
  ...
  "total_cost_usd": 0.004168,
  "cost_per_case_usd": 0.000347,
  "cost_known": true,
  "total_latency_s": 33.29,
  "latency_per_case_s": 2.77,
  "llm_calls": 24,
  "tool_calls": 48
}
```
