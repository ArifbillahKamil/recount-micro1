...
`2` model calls (`0` replayed from cassette) · `2` tool calls · `1749` tokens · `$0.00034`
...
`gpt-4o-mini` · live call · 576 in / 72 out · 1.20s
...
`gpt-4o-mini` · live call · 1006 in / 95 out · 1.25s
