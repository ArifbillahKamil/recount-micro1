...
`2` model calls (`1` replayed from cassette) · `2` tool calls · `1796` tokens · `$0.00035`
...
`gpt-4o-mini` · live call · 581 in / 67 out · 1.24s
...
`gpt-4o-mini` · replayed · 1027 in / 121 out · 0.00s
