...
`2` model calls (`0` replayed from cassette) · `2` tool calls · `1796` tokens · `$0.00035`
...
`gpt-4o-mini` · live call · 595 in / 68 out · 1.44s
...
`gpt-4o-mini` · live call · 1015 in / 118 out · 1.65s
