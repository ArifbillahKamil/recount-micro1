...
`2` model calls (`0` replayed from cassette) · `2` tool calls · `1857` tokens · `$0.00040`
...
`gpt-4o-mini` · live call · 580 in / 83 out · 1.29s
...
`gpt-4o-mini` · live call · 1019 in / 175 out · 1.81s
