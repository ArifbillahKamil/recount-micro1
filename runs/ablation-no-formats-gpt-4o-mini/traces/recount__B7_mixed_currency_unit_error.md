...
`2` model calls (`0` replayed from cassette) · `2` tool calls · `1862` tokens · `$0.00038`
...
`gpt-4o-mini` · live call · 592 in / 75 out · 1.08s
...
`gpt-4o-mini` · live call · 1051 in / 144 out · 2.38s
