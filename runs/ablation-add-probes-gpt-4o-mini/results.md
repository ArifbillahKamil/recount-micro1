...
| `B6_timezone_day_misattribution` | BUG | BUG | TP | timezone_day_boundary | wrong | The query under review counts orders based on UTC date filtering, whic... |
...
| `C4_clean_half_open_date_range` | CLEAN | BUG | FP | timezone_day_boundary | wrong | The query under review does not account for the potential presence of ... |
...
```json
{
  ...
  "total_cost_usd": 0.009658,
  "cost_per_case_usd": 0.000805,
  "cost_known": true,
  "total_latency_s": 9.63,
  "latency_per_case_s": 0.8,
  "llm_calls": 37,
  "tool_calls": 73
}
```
