...
| `B2_fanout_units_via_payments` | BUG | BUG | TP | wrong_aggregation_grain | correct | The query under review joins the 'payments' table, which is not necess... |
...
| `B7_mixed_currency_unit_error` | BUG | BUG | TP | mixed_unit_aggregation | correct | The query under review aggregates revenue from payments without filter... |
...
```json
{
  ...
  "total_cost_usd": 0.004326,
  "cost_per_case_usd": 0.00036,
  "cost_known": true,
  "total_latency_s": 23.02,
  "latency_per_case_s": 1.92,
  "llm_calls": 24,
  "tool_calls": 24
}
```
