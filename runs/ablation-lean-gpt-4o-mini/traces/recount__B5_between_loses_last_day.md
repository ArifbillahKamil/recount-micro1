...
`2` model calls (`1` replayed from cassette) · `2` tool calls · `1867` tokens · `$0.00040`
...
`gpt-4o-mini` · live call · 1024 in / 181 out · 3.10s
