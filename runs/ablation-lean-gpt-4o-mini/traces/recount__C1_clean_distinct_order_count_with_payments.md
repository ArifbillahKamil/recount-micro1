...
`2` model calls (`1` replayed from cassette) · `2` tool calls · `1856` tokens · `$0.00036`
...
`gpt-4o-mini` · replayed · 588 in / 79 out · 0.00s
...
`gpt-4o-mini` · live call · 1081 in / 108 out · 1.49s
