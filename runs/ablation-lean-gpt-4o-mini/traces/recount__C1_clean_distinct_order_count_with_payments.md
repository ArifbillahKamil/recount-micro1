...
`2` model calls (`1` replayed from cassette) · `2` tool calls · `1863` tokens · `$0.00036`
...
`gpt-4o-mini` · replayed · 592 in / 81 out · 0.00s
...
`gpt-4o-mini` · live call · 1081 in / 109 out · 2.39s
