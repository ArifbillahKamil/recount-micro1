...
`2` model calls (`1` replayed from cassette) · `3` tool calls · `2062` tokens · `$0.00041`
...
`gpt-4o-mini` · live call · 757 in / 77 out · 1.02s
...
`gpt-4o-mini` · replayed · 1084 in / 144 out · 0.00s
