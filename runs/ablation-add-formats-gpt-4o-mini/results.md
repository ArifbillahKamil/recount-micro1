# Evaluation — ablation-add-formats-gpt-4o-mini
...
| `B6_timezone_day_misattribution` | BUG | CLEAN | FN | - | - | Both the query under review and the independent recomputation return t... |
...
| `C2_clean_units_sold_at_line_grain` | CLEAN | CLEAN | TN | - | - | The query correctly sums the quantity of order items from completed or... |
...
```json
{
  ...
  "total_cost_usd": 0.004513,
  "cost_per_case_usd": 0.000376,
  "cost_known": true,
  "total_latency_s": 22.89,
