...
Model `gpt-4o-mini` · mode `record` · profile OFF · formats on · probes OFF · gate on
...
```json
{
  ...
  "cost_known": true,
  "total_latency_s": 24.95,
  "latency_per_case_s": 2.08,
  "llm_calls": 12,
  "tool_calls": 0
}
```
...
```json
{
  ...
  "cost_known": true,
  "total_latency_s": 32.16,
  "latency_per_case_s": 2.68,
  "llm_calls": 24,
  "tool_calls": 36
}
```
