...
`3` model calls (`0` replayed from cassette) · `7` tool calls · `3180` tokens · `$0.00078`
...
`gpt-4o-mini` · live call · 421 in / 62 out · 1.14s
...
`gpt-4o-mini` · live call · 759 in / 492 out · 6.88s
...
`gpt-4o-mini` · live call · 1319 in / 127 out · 1.96s
