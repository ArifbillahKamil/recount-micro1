...
`2` model calls (`0` replayed from cassette) · `2` tool calls · `1799` tokens · `$0.00035`
...
`gpt-4o-mini` · live call · 623 in / 71 out · 1.38s
...
`gpt-4o-mini` · live call · 1006 in / 99 out · 1.30s
