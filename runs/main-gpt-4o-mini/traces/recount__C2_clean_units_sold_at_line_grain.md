...
`3` model calls (`0` replayed from cassette) · `7` tool calls · `3295` tokens · `$0.00080`
...
`gpt-4o-mini` · live call · 532 in / 69 out · 1.31s
...
`gpt-4o-mini` · live call · 759 in / 489 out · 5.11s
...
`gpt-4o-mini` · live call · 1320 in / 126 out · 1.72s
