...
`3` model calls (`0` replayed from cassette) · `7` tool calls · `2667` tokens · `$0.00065`
...
`gpt-4o-mini` · live call · 356 in / 61 out · 1.09s
...
`gpt-4o-mini` · live call · 648 in / 394 out · 4.69s
...
`gpt-4o-mini` · live call · 1109 in / 99 out · 1.43s
