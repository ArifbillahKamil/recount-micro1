...
`3` model calls (`0` replayed from cassette) · `7` tool calls · `2696` tokens · `$0.00064`
...
`gpt-4o-mini` · live call · 432 in / 61 out · 1.28s
...
`gpt-4o-mini` · live call · 648 in / 387 out · 6.11s
...
`gpt-4o-mini` · live call · 1091 in / 77 out · 1.29s
