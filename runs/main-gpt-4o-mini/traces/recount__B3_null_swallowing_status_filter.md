...
`3` model calls (`0` replayed from cassette) · `7` tool calls · `2753` tokens · `$0.00069`
...
`gpt-4o-mini` · live call · 364 in / 62 out · 1.64s
...
`gpt-4o-mini` · live call · 649 in / 441 out · 4.12s
...
`gpt-4o-mini` · live call · 1115 in / 122 out · 1.85s
